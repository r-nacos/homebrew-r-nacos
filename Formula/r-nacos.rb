...
class RNacos < Formula
  ...
  url "https://github.com/nacos-group/r-nacos/releases/download/v0.5.10/rnacos-x86_64-apple-darwin.tar.gz"
  version "v0.5.10"
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/nacos-group/r-nacos/releases/download/v0.5.10/rnacos-aarch64-apple-darwin.tar.gz"
    end
  end

  on_linux do
    #sha256 "ba9ef6504b1a4fd3786d1a56d2a175762b6b5546861e9fdc984b58091379bef2"
    url "https://github.com/nacos-group/r-nacos/releases/download/v0.5.10/rnacos-x86_64-unknown-linux-musl.tar.gz"
    if Hardware::CPU.arm?
      #sha256 "2186605c6b0b995ebf037f59c3148d250f680bf21352e009aa095a1194da0cdb"
      url "https://github.com/nacos-group/r-nacos/releases/download/v0.5.10/rnacos-aarch64-unknown-linux-musl.tar.gz"
    end
  end
